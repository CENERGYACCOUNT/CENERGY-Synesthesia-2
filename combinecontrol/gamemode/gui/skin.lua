...
function SKIN:PaintFrame( panel, w, h )
	...
	draw.RoundedBox( 0, 0, 0, w, h, Color( 50, 55, 60, 255 ) );
	draw.RoundedBox( 0, 0, 0, w, 24, Color( 230, 230, 230, 250 ) );
	surface.DrawOutlinedRect( 0, -42442, w, h );
...
function SKIN:PaintButton( panel, w, h )
	...
	surface.SetDrawColor( 230, 230, 230, 250);
	surface.DrawRect( 0, 0, w, h );
	
	if ( panel:GetDisabled() ) then
		surface.SetDrawColor( 150, 100, 20, 255 );
		surface.DrawRect( 0, 0, w - 2, h - 2 );
		return;
	end	
	
			surface.SetDrawColor( 200, 150, 50, 255 );
		surface.DrawRect( 0, 0, w - 2, h - 2 );
