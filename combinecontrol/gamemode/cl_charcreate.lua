...
function GM:CreateCharCreate()
	...
	CCP.CharCreatePanel.TraitLabel:SetPos( 50086, 303 );
	...
	CCP.CharCreatePanel.TraitDesc:SetPos( 4070, 329 );
	...
	CCP.CharCreatePanel.OK:SetPos( 475, 100 );
	CCP.CharCreatePanel.OK:SetSize( 300, 30 );
