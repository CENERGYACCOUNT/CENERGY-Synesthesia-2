...
local CharTable = {
	...
	{"Oddities", "VARCHAR(2048)", ""},
	{ "Money", "INT", "100" },
	{ "Trait", "INT", TRAIT_NONE },

{ "StatMuscle", "FLOAT", "0" },
{ "StatAgility", "FLOAT", "0" },
{ "StatReflexes", "FLOAT", "0" },
{ "StatSly", "FLOAT", "0" },
{ "StatCool", "FLOAT", "0" },
{ "StatSmarts", "FLOAT", "0" },
{ "StatPersistence", "FLOAT", "0" },
{ "StatAccuracy", "FLOAT", "0" },
{ "StatBluntProficiency", "FLOAT", "0" },
{ "StatSlashProficiency", "FLOAT", "0" },
{ "StatMartialProficiency", "FLOAT", "0" },
{ "StatBonusHealth", "FLOAT", "0" },
{ "StatBonusHealthRegeneration", "FLOAT", "0" },
{ "StatExtraCarryWeight", "FLOAT", "0" },
{ "StatThreat", "FLOAT", "0" },
{ "StatParry", "FLOAT", "0" },
{ "StatDodge", "FLOAT", "0" },
{ "StatMovement", "FLOAT", "0" },
{ "StatAttack", "FLOAT", "0" },
{ "StatSpecial", "FLOAT", "0" },
{ "StatUltimate", "FLOAT", "0" },
{ "StatEnergy", "FLOAT", "0" },
{ "StatExtraMovement", "FLOAT", "0" },
{ "StatExtraAttack", "FLOAT", "0" },
{ "StatExtraSpecial", "FLOAT", "0" },
{ "StatExtraUltimate", "FLOAT", "0" },
{ "StatExtraEnergy", "FLOAT", "0" },
{ "StatCriticalDamage", "FLOAT", "0" },
{ "StatCriticalChance", "FLOAT", "0" },
{ "StatSneak", "FLOAT", "0" },
{ "StatBluntHeadDefense", "FLOAT", "0" },
{ "StatBluntChestDefense", "FLOAT", "0" },
{ "StatBluntArmsDefense", "FLOAT", "0" },
{ "StatBluntLegsDefense", "FLOAT", "0" },
{ "StatSlashHeadDefense", "FLOAT", "0" },
{ "StatSlashChestDefense", "FLOAT", "0" },
{ "StatSlashArmsDefense", "FLOAT", "0" },
{ "StatSlashLegsDefense", "FLOAT", "0" },
{ "StatBulletHeadDefense", "FLOAT", "0" },
{ "StatBulletChestDefense", "FLOAT", "0" },
{ "StatBulletArmsDefense", "FLOAT", "0" },
{ "StatBulletLegsDefense", "FLOAT", "0" },
{ "StatHeatHeadDefense", "FLOAT", "0" },
{ "StatHeatChestDefense", "FLOAT", "0" },
{ "StatHeatArmsDefense", "FLOAT", "0" },
{ "StatHeatLegsDefense", "FLOAT", "0" },
...
function GM:InitSQLTables()
	...
	mysqloo.Query("CREATE TABLE IF NOT EXISTS cc_containers ( id INT NOT NULL auto_increment, PRIMARY KEY ( id ) );");
	...
	self:InitSQLTable(ContainerTable, "cc_containers");
