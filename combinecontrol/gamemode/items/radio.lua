...
ITEM.Name			= "Radio"
ITEM.Description	= "A handheld radio, with controllable frequency."

ITEM.Model			= "models/marauder/alliance/marines/items/visr.mdl"
...
ITEM.License = LICENSE_TIER1;
ITEM.Buyable = true;
ITEM.Sellable = true;
ITEM.SinglePrice = 300;
