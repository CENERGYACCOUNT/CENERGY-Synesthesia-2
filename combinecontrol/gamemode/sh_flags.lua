...
function meta:HasAnyCombineFlag()
	...
	if( self:HasCharFlag( "A" ) ) then return true end
	if( self:HasCharFlag( "B" ) ) then return true end
	if( self:HasCharFlag( "C" ) ) then return true end
	if( self:HasCharFlag( "E" ) ) then return true end
	if( self:HasCharFlag( "Q" ) ) then return true end
...
if( #files > 0 ) then
	...
	for _, v in pairs( files ) do
		...
		FLAG.Bodygroup		= function( ply ) end
