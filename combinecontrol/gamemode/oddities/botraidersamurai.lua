...
ply:SetBadGuy( true );
        ...
        local bluntArmor = RoundToFive(math.random(5, 10))
        local slashArmor = RoundToFive(math.random(30, 75))
        local heatArmor = RoundToFive(math.random(95, 100))
        local bulletArmor = RoundToFive(math.random(10, 35))
        local dodge = RoundToFive(math.random(50, 75))
     ...
     local weaponChoice = "weapon_cc_meleesword" .. math.random(4, 4) -- Picks either 2 or 3
