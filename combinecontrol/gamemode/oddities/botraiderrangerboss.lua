...
ply:SetBadGuy( true );
        ...
        local bluntArmor = RoundToFive(math.random(45, 75))
        local slashArmor = RoundToFive(math.random(45, 75))
        local heatArmor = RoundToFive(math.random(30, 45))
        local bulletArmor = RoundToFive(math.random(45, 65))
