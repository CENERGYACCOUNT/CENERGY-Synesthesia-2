...
ply:SetBadGuy( true );
        ...
        local bluntArmor = RoundToFive(math.random(30, 75))
        local slashArmor = RoundToFive(math.random(30, 75))
        local heatArmor = RoundToFive(math.random(15, 25))
        local bulletArmor = RoundToFive(math.random(35, 50))
        local dodge = RoundToFive(math.random(10, 35))
     ...
     local weaponChoice = "weapon_cc_meleesword" .. math.random(2, 3) -- Picks either 2 or 3
