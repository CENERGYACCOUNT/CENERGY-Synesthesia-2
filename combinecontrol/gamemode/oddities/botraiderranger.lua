...
ply:SetBadGuy( true );
        ...
        local bluntArmor = RoundToFive(math.random(25, 30))
        local slashArmor = RoundToFive(math.random(25, 30))
        local heatArmor = RoundToFive(math.random(10, 25))
        local bulletArmor = RoundToFive(math.random(75, 85))
        local dodge = RoundToFive(math.random(5, 25))
...
local weapons = { "weapon_cc_wastelandcorifle", "weapon_cc_wastelandcobeaster" }  
