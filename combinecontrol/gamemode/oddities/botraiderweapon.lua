...
ply:SetBadGuy( true );
        ...
        local bluntArmor = RoundToFive(math.random(25, 50))
        local slashArmor = RoundToFive(math.random(20, 50))
        local heatArmor = RoundToFive(math.random(10, 25))
        local bulletArmor = RoundToFive(math.random(25, 50))
        local dodge = RoundToFive(math.random(5, 20))
...
local weapons = { "weapon_cc_wastelandcorifle", "weapon_cc_wastelandcoscrapper" }  
