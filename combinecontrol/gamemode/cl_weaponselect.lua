...
function GM:DrawWeaponSelect()
	...
	if( a > 0 ) then
		...
		if( self.WeaponSelectSlot == 1 ) then
			...
			draw.RoundedBox( 0, ScrW() / 2 - self.WeaponSelectWidth / 2 - 20 - self.WeaponSelectWidth, 20, self.WeaponSelectWidth, 30, Color( 200, 150, 50, 200 * a ) );
			draw.RoundedBox( 0, ScrW() / 2 - self.WeaponSelectWidth / 2, 20, self.WeaponSelectWidth, 30, Color( 100, 100, 100, 100 * a ) );
			draw.RoundedBox( 0, ScrW() / 2 - self.WeaponSelectWidth / 2 + 20 + self.WeaponSelectWidth, 20, self.WeaponSelectWidth, 30, Color( 100, 100, 100, 100 * a ) );
			
			draw.DrawTextShadow( "Abilities", "CyberHUDBig", ScrW() / 2 - 20 - self.WeaponSelectWidth, 25, Color( 200, 200, 200, 255 * a ), Color( 0, 0, 0, 255 * a ), 1 );
			draw.DrawTextShadow( "Weapons", "CyberHUDBig", ScrW() / 2, 25, Color( 200, 200, 200, 200 * a ), Color( 0, 0, 0, 200 * a ), 1 );
			draw.DrawTextShadow( "Build", "CyberHUDBig", ScrW() / 2 + 20 + self.WeaponSelectWidth, 25, Color( 200, 200, 200, 200 * a ), Color( 0, 0, 0, 200 * a ), 1 );
			
		elseif( self.WeaponSelectSlot == 2 ) then
			
			draw.RoundedBox( 0, ScrW() / 2 - self.WeaponSelectWidth / 2 - 20 - self.WeaponSelectWidth, 20, self.WeaponSelectWidth, 30, Color( 100, 100, 100, 100 * a ) );
			draw.RoundedBox( 0, ScrW() / 2 - self.WeaponSelectWidth / 2, 20, self.WeaponSelectWidth, 30, Color( 200, 150, 50, 200 * a ) );
			draw.RoundedBox( 0, ScrW() / 2 - self.WeaponSelectWidth / 2 + 20 + self.WeaponSelectWidth, 20, self.WeaponSelectWidth, 30, Color( 100, 100, 100, 100 * a ) );
			
			draw.DrawTextShadow( "Abilities", "CyberHUDBig", ScrW() / 2 - 20 - self.WeaponSelectWidth, 25, Color( 200, 200, 200, 200 * a ), Color( 0, 0, 0, 200 * a ), 1 );
			draw.DrawTextShadow( "Weapons", "CyberHUDBig", ScrW() / 2, 25, Color( 200, 200, 200, 255 * a ), Color( 0, 0, 0, 255 * a ), 1 );
			draw.DrawTextShadow( "Build", "CyberHUDBig", ScrW() / 2 + 20 + self.WeaponSelectWidth, 25, Color( 200, 200, 200, 200 * a ), Color( 0, 0, 0, 200 * a ), 1 );
			...
			draw.DrawTextShadow( "Abilities", "CyberHUDBig", ScrW() / 2 - 20 - self.WeaponSelectWidth, 25, Color( 200, 200, 200, 200 * a ), Color( 0, 0, 0, 200 * a ), 1 );
			draw.DrawTextShadow( "Weapons", "CyberHUDBig", ScrW() / 2, 25, Color( 200, 200, 200, 200 * a ), Color( 0, 0, 0, 200 * a ), 1 );
			draw.DrawTextShadow( "Build", "CyberHUDBig", ScrW() / 2 + 20 + self.WeaponSelectWidth, 25, Color( 200, 200, 200, 255 * a ), Color( 0, 0, 0, 255 * a ), 1 );
		...
		for k, v in pairs( LocalPlayer():GetWeaponsInSlot( self.WeaponSelectSlot ) ) do
			...
			local c = Color( 100, 100, 100, 200 * a );
			
			if( self.WeaponSelectSlotPos == k ) then
				
				c = Color( 200, 150, 50, 200 * a );
			...
			if( self.WeaponSelectSlotPos == k ) then
				...
				draw.DrawTextShadow( text, "CyberHUD", ScrW() / 2 - self.WeaponSelectWidth / 2 - 20 - self.WeaponSelectWidth + 10, 70 + y + 10, Color( 200, 200, 200, 200 * a ), Color( 0, 0, 0, 200 * a ), 0 );
