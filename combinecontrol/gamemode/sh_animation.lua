...
function GM:GetValidGestures( ply )
	...
	tab["Gesture: Forward"] = ACT_SIGNAL_FORWARD
		tab["Gesture: Look"] = "g_look"
		tab["Gesture: I Dunno"] = "g_shrug"
		tab["Gesture: Follow Me"] = "wave"
		tab["Gesture: Over Here!"] = "wave_smg1"
		tab["Gesture: Point"] = "g_frustrated_point"
		tab["Gesture: Present"] = "g_present"
		tab["Gesture: Raise Hand"] = "g_pumpleft_rpgdown"
		tab["Gesture: Agree"] = "hg_nod_yes"
		tab["Gesture: Disagree"] = "hg_nod_no"
		tab["Gesture: Clap"] = "cheer2"
		tab["Gesture: Halt"] = ACT_SIGNAL_HALT
		tab["Gesture: Group"] = ACT_SIGNAL_GROUP
		tab["Gesture: Thumbs Up"] = ACT_GMOD_GESTURE_AGREE
		tab["Gesture: Finger Wag"] = ACT_GMOD_GESTURE_DISAGREE
		tab["Gesture: Beckon"] = ACT_GMOD_GESTURE_BECON
		tab["Gesture: Wave"] = ACT_GMOD_GESTURE_WAVE
		tab["Gesture: Salute"] = ACT_GMOD_TAUNT_SALUTE
		tab["Gesture: Praise!"] = "g_armsout_high"
