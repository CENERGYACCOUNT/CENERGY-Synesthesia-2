...
SWEP.PrintName = "Ability: Head Hunting"
SWEP.Slot = 1
SWEP.SlotPos = 13
...
SWEP.Itemize = true
SWEP.ItemDescription = "Your rifle headshot damage is increased further by 50%. Costs 5S and 1E."
SWEP.ItemWeight = 0
SWEP.ItemFOV = 11
...
function SWEP:PrimaryAttack()
    ...
    if self.Owner:Energy() > 1 - 0.1 then
        ...
        if SERVER then
            ...
            self.Owner:GiveOddity("statusheadhunting")
