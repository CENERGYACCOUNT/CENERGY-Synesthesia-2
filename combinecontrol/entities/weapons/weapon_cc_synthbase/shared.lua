...
function SWEP:Reload()
   ...
   if( self.Owner:Special() > self.Primary.ReloadCostS -0.001 ) then
   if( self.Owner:Attack() > self.Primary.ReloadCostA -0.001 ) then
   if( self.Owner:Movement() > self.Primary.ReloadCostM -0.001 ) then
if( SERVER ) then
