...
-- General
SWEP.Base			= "weapon_cc_synthbase"
SWEP.Firearm            = true
SWEP.Primary.InfiniteAmmo  = true
-- Inventory
SWEP.PrintName 		= "Test Melee"
SWEP.Itemize = true
SWEP.ItemDescription = "test melee"
SWEP.ItemWeight = 4
SWEP.ItemFOV = 12;
...
SWEP.ViewModel       = "models/weapons/bo3_melees/prosthetic/c_prosthetic.mdl"
SWEP.WorldModel   = "models/weapons/bo3_melees/prosthetic/w_prosthetic.mdl"
...
-- Anims
SWEP.Primary.AnimationHit = "misscenter"  -- Default hit animation
SWEP.Primary.AnimationMiss = "misscenter"  -- Default miss animation
...
SWEP.Primary.CritChance        = -5525
SWEP.Primary.CritDamage        = 1550
SWEP.Primary.Force         = 10
SWEP.Primary.DamageType = "heat" -- Options: "bullet", "slash", "blunt", "heat"
...
SWEP.Primary.MaxRange = 75  -- Default, can be changed per weapon
...
-- Costs
SWEP.Primary.AttackCost   = 1
SWEP.Primary.ReloadCost   = 5
 
SWEP.StatMultipliers = {
    MuscleTemporary = { damage = 2, penetration = 0, shredding = 5, maxRange = 0 },
    AgilityTemporary = { damage = 0, penetration = 0, shredding = 0, maxRange = 0 },
...
local function ApplyShredding(entity, defenseType, hitPart, rangeFactor)
    ...
    if entity[defenseMethod] and entity[setDefenseMethod] then
        ...
        local newDefense = math.max(currentDefense - adjustedShreddingValue *2, 0)
        ...
        if effectivePenetration >= armorValue then
            ...
            local critDamage = self.Owner:CriticalDamageTemporary() + self.Primary.CritDamage or 0  -- Expected to return a percentage bonus
              if math.random(1, 100) <= critChance then
                ...
                -- Play critical sound
                ply:EmitSound("npc/turret/tu_spindown.wav")
            end
