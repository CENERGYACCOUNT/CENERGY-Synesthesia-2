...
-- Inventory
SWEP.PrintName 		= "Nomad Blade"
SWEP.Itemize = true
SWEP.ItemDescription = "Nomad Blade"
SWEP.ItemWeight = 4
SWEP.ItemFOV = 12;
...
SWEP.ViewModel       = "models/weapons/tfa_kf2/c_vibrokatana.mdl"
SWEP.WorldModel   = "models/weapons/tfa_kf2/w_vibrokatana.mdl"
...
-- Anims
SWEP.Primary.AnimationHit = "bash"  -- Default hit animation
SWEP.Primary.AnimationMiss = "atk_l"  -- Default miss animation
