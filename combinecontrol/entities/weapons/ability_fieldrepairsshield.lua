...
SWEP.PrintName = "Ability: Field Shield Repairs"
SWEP.Slot = 1
SWEP.SlotPos = 15
...
SWEP.Itemize = true
SWEP.ItemDescription = "Repair your force shield."
SWEP.ItemWeight = 0
SWEP.ItemFOV = 11
...
function SWEP:PerformActionOnTarget(target)
    ...
    if not IsValid(target) or target:GetClass() ~= "cc_synthshield" then
...
function SWEP:GetTargetEntity()
    ...
    if tr.Entity and tr.Entity:GetClass() == "cc_synthshield" then
