...
SWEP.PrintName = "Ability: Knee Shooting"
SWEP.Slot = 1
SWEP.SlotPos = 11
...
SWEP.Itemize = true
SWEP.ItemDescription = "Your rifle cripple chance is increased by 25%. Costs 5S and 1E."
SWEP.ItemWeight = 0
SWEP.ItemFOV = 11
...
function SWEP:PrimaryAttack()
    ...
    if self.Owner:Energy() > 1 - 0.1 then
        ...
        if SERVER then
            ...
            self.Owner:GiveOddity("statuskneeshooting")
