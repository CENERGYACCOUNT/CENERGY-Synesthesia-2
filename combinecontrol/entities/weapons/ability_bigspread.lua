...
SWEP.PrintName = "Ability: Big Spread"
SWEP.Slot = 1
SWEP.SlotPos = 18
...
SWEP.Itemize = true
SWEP.ItemDescription = "Prime your next shotgun shot to have double the projectiles, but decrease it's accuracy. Costs 5S."
SWEP.ItemWeight = 0
SWEP.ItemFOV = 11
...
function SWEP:PrimaryAttack()
    ...
    if self.Owner:Special() > 5 - 0.1 then
        ...
        if self.Owner:HasOddity("statusbigspread") then
            return
        end
        ...
        if SERVER then
            ...
            self.Owner:GiveOddity("statusbigspread")
