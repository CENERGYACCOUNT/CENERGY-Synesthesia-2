...
-- Table to store all voice sound lists by oddity
local VoiceSounds = {
    voice1 = {
        boost = {
            "vj_htunsc/npc/marines/sergeant1/celebration_4.wav",
            "vj_htunsc/npc/marines/sergeant1/celebration_1.wav",
            "vj_htunsc/npc/marines/sergeant1/celebration_5.wav",
            "vj_htunsc/npc/marines/sergeant1/advance_5.wav",
            "vj_htunsc/npc/marines/sergeant1/alertfriendre_4.wav"

        },
        order = {
            "vj_htunsc/npc/marines/sergeant1/advance_23.wav",
            "vj_htunsc/npc/marines/sergeant1/advance_22.wav",
            "vj_htunsc/npc/marines/sergeant1/advance_26.wav",
            "vj_htunsc/npc/marines/sergeant1/fleere_4.wav",
            "vj_htunsc/npc/marines/sergeant1/fleere_5.wav",
            "vj_htunsc/npc/marines/sergeant1/fleere_7.wav",
            "vj_htunsc/npc/marines/sergeant1/advance_24.wav",
            "vj_htunsc/npc/marines/sergeant1/fleere_13.wav",
            "vj_htunsc/npc/marines/sergeant1/advance_25.wav",
            "vj_htunsc/npc/marines/sergeant1/cover_1.wav",
            "vj_htunsc/npc/marines/sergeant1/fleere_10.wav",
            "vj_htunsc/npc/marines/sergeant1/alertfriend_5.wav",
            "vj_htunsc/npc/marines/sergeant1/blocked_4.wav",
            "vj_htunsc/npc/marines/sergeant1/celebration_3.wav",
            "vj_htunsc/npc/marines/sergeant1/blockedre_1.wav"

        },
            warcry = {
            "vj_htunsc/npc/marines/sergeant1/berserk_10.wav",
            "vj_htunsc/npc/marines/sergeant1/berserk_11.wav",
            "vj_htunsc/npc/marines/sergeant1/berserk_6.wav",
            "vj_htunsc/npc/marines/sergeant1/berserk_9.wav",
            "vj_htunsc/npc/marines/sergeant1/berserk_8.wav"


        },
        debuff = {
            "vj_htunsc/npc/marines/sergeant1/killedenemybullet_4.wav",
            "vj_htunsc/npc/marines/sergeant1/newcombatalone_4.wav",
            "vj_htunsc/npc/marines/sergeant1/newcombatalone_2.wav",
            "vj_htunsc/npc/marines/sergeant1/newcombatgroupre_6.wav",
            "vj_htunsc/npc/marines/sergeant1/oldenemysighted_4.wav",
            "vj_htunsc/npc/marines/sergeant1/damagedenemy_35.wav",
            "vj_htunsc/npc/marines/sergeant1/celebration_8.wav",
            "vj_htunsc/npc/marines/sergeant1/advance_23.wav",
            "vj_htunsc/npc/marines/sergeant1/newcombatalone_5.wav",
            "vj_htunsc/npc/marines/sergeant1/friendkilledbyenemyplayer_4.wav",
            "vj_htunsc/npc/marines/sergeant1/friendkilledbyenemyplayer_5.wav",
            "vj_htunsc/npc/marines/sergeant1/friendkilledbyflood_5.wav",
    ...
    voice2 = {
        boost = {
            "vj_htunsc/npc/marines/sergeant2/alertfriendre_1.wav",
             "vj_htunsc/npc/marines/sergeant2/blocked_6.wav",
            "vj_htunsc/npc/marines/sergeant2/celebration_5.wav",
            "vj_htunsc/npc/marines/sergeant2/cover_5.wav",
            "vj_htunsc/npc/marines/sergeant2/cover_8.wav"

        },
        order = {
         "vj_htunsc/npc/marines/sergeant2/advance_1.wav",
            "vj_htunsc/npc/marines/sergeant2/advance_15.wav",
            "vj_htunsc/npc/marines/sergeant2/advance_16.wav",
            "vj_htunsc/npc/marines/sergeant2/advance_18.wav",
            "vj_htunsc/npc/marines/sergeant2/advance_24.wav",
            "vj_htunsc/npc/marines/sergeant2/advance_7.wav",
            "vj_htunsc/npc/marines/sergeant2/advance_5.wav",
            "vj_htunsc/npc/marines/sergeant2/alertlostcontactre_11.wav",
            "vj_htunsc/npc/marines/sergeant2/alertfriend_1.wav",
            "vj_htunsc/npc/marines/sergeant2/celebration_3.wav",
            "vj_htunsc/npc/marines/sergeant2/groupuncoverre_3.wav",
            "vj_htunsc/npc/marines/sergeant2/cover_7.wav",
            "vj_htunsc/npc/marines/sergeant2/cover_3.wav",
            "vj_htunsc/npc/marines/sergeant2/alertfriend_2.wav"
        },
             warcry = {
            "vj_htunsc/npc/marines/sergeant2/berserk_7.wav",
            "vj_htunsc/npc/marines/sergeant2/berserk_6.wav",
            "vj_htunsc/npc/marines/sergeant2/berserk_2.wav",
            "vj_htunsc/npc/marines/sergeant2/berserk_1.wav",
            "vj_htunsc/npc/marines/sergeant2/advance_1.wav"
  

        },
        debuff = {
            "vj_htunsc/npc/marines/sergeant2/celebration_8.wav",
            "voice_replacement/republic_comando_sev_combine/debuff4.wav",
            "vj_htunsc/npc/marines/sergeant2/damagedenemy_5.wav",
            "vj_htunsc/npc/marines/sergeant2/killedenemyfloodcarriercm_16.wav",
            "vj_htunsc/npc/marines/sergeant2/killedenemyfloodcombatcm_1.wav",
            "vj_htunsc/npc/marines/sergeant2/damagedenemy_3.wav",
            "vj_htunsc/npc/marines/sergeant2/friendkilledbyenemyplayer_11.wav",
            "vj_htunsc/npc/marines/sergeant2/friendkilledbyenemyplayer_13.wav",
            "vj_htunsc/npc/marines/sergeant2/friendkilledbyenemyplayer_12.wav",
            "vj_htunsc/npc/marines/sergeant2/friendkilledbyflood_3.wav",
            "vj_htunsc/npc/marines/sergeant2/friendkilledbyflood_9.wav"
        ...
        voice3 = {
        boost = {
            "vj_htunsc/npc/marines/tough/11_group/joinme_emrg[4].wav",
             "vj_htunsc/npc/marines/tough/16_taunt/tnt_mjrfoe[5].wav",
            "vj_htunsc/npc/marines/tough/07_exclaim/chr[2].wav",
            "vj_htunsc/npc/marines/tough/07_exclaim/lmnt_deadplr[6].wav",
            "vj_htunsc/npc/marines/sergeant2/cover_8.wav"

        },
        order = {
         "vj_htunsc/npc/marines/tough/09_order/foeordr_advance[4].wav",
            "vj_htunsc/npc/marines/tough/09_order/newordr_fallback[5].wav",
            "vj_htunsc/npc/marines/tough/02_danger/warn[1].wav",
            "vj_htunsc/npc/marines/tough/02_danger/warn[5].wav",
            "vj_htunsc/npc/marines/tough/02_danger/warn_incmn[6].wav",
            "vj_htunsc/npc/marines/tough/06_outburst/cllcoward[4].wav",
            "vj_htunsc/npc/marines/tough/06_outburst/cllcoward[5].wav",
            "vj_htunsc/npc/marines/tough/06_outburst/cllwimp[5].wav",
            "vj_htunsc/npc/marines/tough/09_order/newordr_fallback[7].wav",
            "vj_htunsc/npc/marines/tough/09_order/newordr_moveon[5].wav",
            "vj_htunsc/npc/marines/tough/09_order/newordr_support[6].wav",
            "vj_htunsc/npc/marines/tough/06_outburst/cncrn[1].wav"
        
        },
             warcry = {
            "vj_htunsc/npc/marines/tough/17_threaten/thrtn[1].wav",
            "vj_htunsc/npc/marines/tough/17_threaten/thrtn_elt[16].wav",
            "vj_htunsc/npc/marines/tough/09_order/newordr_charge[2].wav",
            "vj_htunsc/npc/marines/tough/09_order/newordr_charge[8].wav",
            "vj_htunsc/npc/marines/tough/16_taunt/tnt_fld[1].wav"
  

        },
        debuff = {
            "vj_htunsc/npc/marines/tough/01_alert/coming[1].wav",
            "vj_htunsc/npc/marines/tough/01_alert/morefoe[2].wav",
            "vj_htunsc/npc/marines/tough/01_alert/foundfoe[5].wav",
            "vj_htunsc/npc/marines/tough/01_alert/seefoe[5].wav",
            "vj_htunsc/npc/marines/tough/01_alert/seefoe[6].wav",
            "vj_htunsc/npc/marines/tough/01_alert/seefoe[8].wav",
            "vj_htunsc/npc/marines/tough/01_alert/seefoe_agg[7].wav",
            "vj_htunsc/npc/marines/tough/01_alert/seefoe_mjr[2].wav",
            "vj_htunsc/npc/marines/tough/01_alert/seefoe_mjr[1].wav",
            "vj_htunsc/npc/marines/tough/01_alert/coming[3].wav"
       ...
       voice4 = {
        boost = {
            "vj_htunsc/npc/marines/cross/03_strike/strk[6].wav",
             "vj_htunsc/npc/marines/cross/03_strike/strk[5].wav",
            "vj_htunsc/npc/marines/cross/03_strike/strk_grnd[6].wav",
            "vj_htunsc/npc/marines/cross/03_strike/strk_re[3].wav"
  

        },
        order = {
         "vj_htunsc/npc/marines/cross/11_group/joinme[1].wav",
            "vj_htunsc/npc/marines/cross/09_order/newordr_support[3].wav",
            "vj_htunsc/npc/marines/cross/11_group/joinme[4].wav",
            "vj_htunsc/npc/marines/cross/09_order/newordr_advance[5].wav",
            "vj_htunsc/npc/marines/cross/11_group/joinme_emrg[4].wav",
            "vj_htunsc/npc/marines/cross/09_order/newordr_advance[8].wav",
            "vj_htunsc/npc/marines/cross/09_order/newordr_support[1].wav",
            "vj_htunsc/npc/marines/cross/09_order/foeordr_charge[7].wav",
            "vj_htunsc/npc/marines/cross/06_outburst/cllcoward[3].wav"

        },
             warcry = {
            "vj_htunsc/npc/marines/cross/17_threaten/thrtn[1].wav",
            "vj_htunsc/npc/marines/cross/17_threaten/thrtn[5].wav",
            "vj_htunsc/npc/marines/cross/17_threaten/thrtn[6].wav",
            "vj_htunsc/npc/marines/cross/16_taunt/tnt[1].wav",
            "vj_htunsc/npc/marines/cross/03_strike/strk[10].wav"
  

        },
        debuff = {
            "vj_htunsc/npc/marines/cross/11_group/joinme_presrchend[3].wav",
            "vj_htunsc/npc/marines/cross/09_order/newordr_charge[1].wav",
            "vj_htunsc/npc/marines/cross/09_order/newordr_charge[5].wav",
            "vj_htunsc/npc/marines/cross/09_order/newordr_charge[4].wav",
            "vj_htunsc/npc/marines/cross/09_order/newordr_charge[3].wav",
            "vj_htunsc/npc/marines/cross/09_order/newordr_charge[1].wav"
    ...
    -- Add additional voices and voice types as needed
}

-- Function to play a random sound for a specific voice oddity and type
function SWEP:PlayVoice(oddity, voiceType)
    -- Check if the voice oddity and type exist in the table
    if VoiceSounds[oddity] and VoiceSounds[oddity][voiceType] then
        local randomSound = VoiceSounds[oddity][voiceType][math.random(1, #VoiceSounds[oddity][voiceType])]
        self.Owner:EmitSound(randomSound)
    end
end

-- Function to check for oddities and play appropriate voice sounds based on the action type
function SWEP:CheckAndPlayVoice(actionType)
    -- Determine the voice type based on the action
    local voiceType
    if actionType == "boost" then
        voiceType = "boost"
    elseif actionType == "order" then
        voiceType = "order"
    elseif actionType == "debuff" then
        voiceType = "debuff"
    elseif actionType == "warcry" then
        voiceType = "warcry"
  
    end

    -- Check for each voice oddity and play the corresponding sound
    if self.Owner:HasOddity("voice1") then
        self:PlayVoice("voice1", voiceType)
    elseif self.Owner:HasOddity("voice2") then
        self:PlayVoice("voice2", voiceType)
            elseif self.Owner:HasOddity("voice3") then
        self:PlayVoice("voice3", voiceType)
            elseif self.Owner:HasOddity("voice4") then
        self:PlayVoice("voice4", voiceType)
    end 
    -- Add more checks for additional voices if needed
end
...
function SWEP:ThrowingAccuracyModifier( m )
	
	local m = m or 0.8;
	
	local mulstat = 1 - ( self.Owner:Movementpoints() / 100 ) * m;
	local muliron = self.Owner:KeyDown( IN_ATTACK2 ) and 0.7 or 1;
	...
	elseif( self.Melee ) then
		...
		if( tr.Hit ) then
			...
			if( SERVER ) then
				...
				dmg:SetDamage( math.Round( ( ( self.Owner:Extrahp() + 20 ) / 50 ) * ( self.DamageMul or 10 ) * blockmul ) );
