...
SWEP.PrintName = "Ability: Pin Down"
SWEP.Slot = 1
SWEP.SlotPos = 6
...
SWEP.Itemize = true
SWEP.ItemDescription = "Increase your suppression by 25% during this turn. Costs 5S."
SWEP.ItemWeight = 0
SWEP.ItemFOV = 11
...
function SWEP:PrimaryAttack()
    ...
    if self.Owner:Special() > 5 - 0.1 then
        ...
        if SERVER then
            ...
            self.Owner:GiveOddity("statuspindown")
            ...
            self:CheckAndPlayVoice("debuff")  -- Optional voice feedback
