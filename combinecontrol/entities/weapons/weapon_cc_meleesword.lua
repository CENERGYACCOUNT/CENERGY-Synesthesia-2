...
-- Inventory
SWEP.PrintName 		= "R3TRSW0RD - Apexforce"
SWEP.Itemize = true
SWEP.ItemDescription = "Fully conceable, retractable plasticid blade, later replaced by the Apexi Projector Blades. This is a finesse, using Agility to boost it's damage, shredding range and penetration. Costs 2.5A, 25 Damage, Weapon Type: Slash, 25% Crit Chance, 50% Crit Damage, 1 Penetration, 1 Shredding, 75 Range"
SWEP.ItemWeight = 4
SWEP.ItemFOV = 12;
...
SWEP.ViewModel       = "models/tnb/trpweapons/c_t1000_blade.mdl"
SWEP.WorldModel   = "models/tnb/trpweapons/w_t1000_blade.mdl"
...
-- Anims
SWEP.Primary.AnimationHit = "hitkill1"  -- Default hit animation
SWEP.Primary.AnimationMiss = "misscenter1"  -- Default miss animation
SWEP.HoldType = "knife"
...
SWEP.Primary.Penetration = 5
SWEP.Primary.Shredding = 1
SWEP.Primary.DodgeShredding = 0
SWEP.Primary.MaxRange = 100  -- Default, can be changed per weapon
