...
SWEP.PrintName = "DefenCY - Home Defence Sentry Gun Turret"
SWEP.Slot = 1
SWEP.SlotPos = 2
...
SWEP.InfoText = "Primary: Deploy a Sentry Gun."
...
SWEP.Itemize = true
SWEP.ItemDescription = "Deploys a sentry gun that fires for you."
SWEP.ItemWeight = 5
SWEP.ItemFOV = 9
...
function SWEP:PrimaryAttack()
    ...
    local shield = ents.Create("cc_synthsentry")
    ...
    shield:SetPos(pos)
    shield:SetAngles(owner:GetAngles() + Angle(0, 0, 0))  -- Rotate by 160 degrees on the Y-axis
    shield:Spawn()
    shield:Activate()
