...
-- Inventory
SWEP.PrintName 		= "Raider Mace"
SWEP.Itemize = true
SWEP.ItemDescription = "Big ass mace and a shield."
SWEP.ItemWeight = 4
SWEP.ItemFOV = 12;
...
SWEP.ViewModel       = "models/weapons/tfa_kf2/c_shield_mace.mdl"
SWEP.WorldModel   = "models/weapons/tfa_kf2/w_shield_mace.mdl"
...
-- Anims
SWEP.Primary.AnimationHit = "atk_h_r"  -- Default hit animation
SWEP.Primary.AnimationMiss = "bash"  -- Default miss animation
SWEP.HoldType = "melee"
...
SWEP.Primary.DamageType = "blunt" -- Options: "bullet", "slash", "blunt", "heat"
