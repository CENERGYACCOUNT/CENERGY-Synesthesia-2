...
SWEP.PrintName = "Ability: Overheat"
SWEP.Slot = 1
SWEP.SlotPos = 7
...
SWEP.Itemize = true
SWEP.ItemDescription = "For the duration of this turn, you can use Health to fire, once you run out of Attack Points. Costs 5S."
SWEP.ItemWeight = 0
SWEP.ItemFOV = 11
...
function SWEP:PrimaryAttack()
    ...
    if self.Owner:Special() > 5 - 0.1 then
        ...
        if self.Owner:HasOddity("statusoverheat") then
            return
        end
        ...
        if SERVER then
            ...
            self.Owner:GiveOddity("statusoverheat")
