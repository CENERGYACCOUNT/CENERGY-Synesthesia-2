...
SWEP.PrintName = "Ability: Spray and Pray"
SWEP.Slot = 1
SWEP.SlotPos = 4
...
SWEP.Itemize = true
SWEP.ItemDescription = "For the duration of this turn, halve your SMG'S accuracy, but also halve fire cost. Costs 5S."
SWEP.ItemWeight = 0
SWEP.ItemFOV = 11
...
function SWEP:PrimaryAttack()
    ...
    if self.Owner:Special() > 5 - 0.1 then
        ...
        if SERVER then
            ...
            self.Owner:GiveOddity("statussprayandpray")
